...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
/* nested function can access 'internal' because the scope of closure allows varaibals to be reached outwards
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    const displayNames = [];
    array.forEach(index => displayNames.push(`name: ${index['animal_name']}, scientific: ${index['scientific_name']}`))
    return displayNames;
  }
  ...
  */
  ...
  function lowerCaseNames(array){
    const lower = array.map(index => index.animal_name.toLowerCase())
    return lower;
  }
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const newArray = array.filter(foofoo => foofoo['population']<5);
    return newArray;
  }
  ...
  */
  ...
  function USApop(array){
    return array.reduce((total,item) => total += item['population'], 0);
  }
